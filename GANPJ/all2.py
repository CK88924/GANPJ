...
# 訓練和推理生成代碼
def generate_images(model, test_input, tar=None, save_path=None):
...
# 推理生成圖像並保存
def inference(folder_path, output_dir):
    ...
    for image_file in image_files:
        ...
        generate_images(generator, input_image, save_path=save_path)

# 加載模型後進行推理
load_checkpoint()
inference("dataset/outtest", "output_images")
